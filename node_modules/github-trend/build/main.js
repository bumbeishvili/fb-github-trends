        ...
        return this.fetchTrendPage(lang_name).then(function (html) {
            ...
            return dom(".repo-list li")
                ...
                .map(function (li, i) {
                    ...
                    result.description = result.description.replace(emptyStringmatcher, '');
                    result.language = result.language.replace(emptyStringmatcher, '');
                    result.allStars = result.allStars.replace(emptyStringmatcher, '');
                    result.todaysStars = result.todaysStars.replace(emptyStringmatcher, '');
